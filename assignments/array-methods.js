...
runners.forEach(function(firstAndLast) {
    console.log(`${firstAndLast.first_name} 
   ${firstAndLast.last_name}`)});
// runners.forEach(function(firstLast) {
//     console.log(firstLast.first_name);
//     console.log(firstLast.last_name);
//   });
...
const runnersUpperCase = runners.map(function(firstName){
...
const shirtChange = runners.filter(function(firstName){
    return firstName.shirt_size === "L";
});
console.log(shirtChange);
...
const totalLength = runners.filter(function(value){
    return value.last_name.length > 8;
});
console.log(totalLength);
// If their last name is greater than 8 characters they will need bigger space on their shirts and/or smaller font. 

// Problem 3
let nameSize = [];
console.log(nameSize);

runners.forEach(function(nameAndSize) {
    console.log(`${nameAndSize.last_name} 
   ${nameAndSize.shirt_size}`)});

// This list will help speed up the time it takes to hand out shirts by filtering the last name and size. 